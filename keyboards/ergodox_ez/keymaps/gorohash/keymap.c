...
[BASE] = LAYOUT_ergodox_pretty(
  ...
  KC_TAB,   KC_Q,    KC_W,    KC_E,     KC_R,     KC_T,    TG(BASE_WIN),         TG(SYMB),     KC_Y,           KC_U,     KC_I,    KC_O,    KC_P,              KC_EQL,
  KC_LSFT,  KC_A,    KC_S,    KC_D,     KC_F,     KC_G,                                        KC_H,           KC_J,     KC_K,    KC_L,    LT(MDIA, KC_SCLN), RSFT_T(KC_QUOT),
  KC_LGUI,  KC_Z,    KC_X,    KC_C,     KC_V,     KC_B,    ALL_T(KC_NO),         MEH_T(KC_NO), KC_N,           KC_M,     KC_COMM, KC_DOT,  RCTL_T(KC_SLSH),   KC_RGUI,
  MO(SYMB), KC_LCTL, KC_LALT, MO(MDIA), MO(ARRW),                                              KC_LEFT,        KC_RIGHT, KC_LBRC, KC_RBRC, KC_BSLS,
                                                  KC_DEL,  KC_LGUI,              KC_RALT,      RCTL_T(KC_ESC),
                                                           KC_PGUP,              KC_UP,
...
[BASE_WIN] = LAYOUT_ergodox_pretty(
  ...
  LCTL_T(KC_F13), KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,     KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, RCTL_T(KC_F14),
...
[SYMB] = LAYOUT_ergodox_pretty(
  ...
  EEP_RST, KC_PERC, KC_CIRC, KC_LBRC, KC_RBRC, KC_TILD, KC_TRNS,     KC_TRNS, KC_AMPR, KC_1,  KC_2,   KC_3,   KC_BSLS, KC_TRNS,
  KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,                                         KC_0,  KC_DOT, KC_ENT, KC_EQL,  KC_TRNS,
                                               KC_TRNS, KC_TRNS,     KC_TRNS, KC_TRNS,
                                                        KC_TRNS,     KC_TRNS,
                                      KC_TRNS, KC_TRNS, KC_TRNS,     KC_TRNS, KC_TRNS, KC_TRNS
),
